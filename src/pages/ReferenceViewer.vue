<script setup>
import { ref } from 'vue'
import { fetchReferenceWaveforms } from '@/api/referenceApi'
...
// 載入資料
const loadReferenceWaveforms = async () => {
    try {
        const data = await fetchReferenceWaveforms(actionType.value)
...
<template>
    <div>
        ...
        <div class="toolbar">
            ...
            <button @click="loadReferenceWaveforms">載入資料</button>
